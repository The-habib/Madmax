...
public final class TermuxPropertyConstants {
    ...
    //public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[[{key: 'MENU', popup: 'AI', display: '⚡'}, ESC, TAB, CTRL, ALT, {key: '-', popup: '|'}, DOWN, UP]]"; // Single row
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[[{key: 'MENU', popup: 'AI', display: '⚡'},'ESC','/',{key: '-', popup: '|'},'HOME','UP','END','PGUP'], ['TAB','CTRL','ALT','PASTE','LEFT','DOWN','RIGHT','PGDN']]"; // Double row
